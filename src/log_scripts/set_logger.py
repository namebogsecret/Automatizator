...
def archive_large_logs(logs_dir, max_size_mb=10):
    ...
    try:
        ...
        write_to_file(f"Ошибка при архивации больших логов: {e}")
...
def archive_old_logs(logs_dir):
    ...
    try:
        ...
        write_to_file(f"Ошибка при архивации устаревших логов: {e}")
...
def set_logger_(logger, logs_dir):
    ...
    try:
        ...
        write_to_file(f"Ошибка при настройке логгера1: {e}")
...
def set_logger(logger):
    try:
        ...
        write_to_file(f"Ошибка при настройке логгера2: {e}")